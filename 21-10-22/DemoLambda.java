...
public class DemoLambda {
	...
	public static void main(String[] args) {
		...
		// Imprime los elementos en consola de listaAlumnos

		System.out.println("*** Lista de Alumnos ***");
		listaAlumnos.stream().forEach(a -> System.out.println("print: " + a));

		// "Filtra" los elementos acorde a la condicion, y dado que es true en todo
		// momento retorna el mismo
		// numero de elementos y los imprime, por tanto realiza la misma funcion que la
		// expresion anterior.

		listaAlumnos.stream().filter(a -> true).forEach(a -> System.out.println("filter" + a));
		...
		// System.out::println hace referencia a c -> System.out.println(c);
		...
		// Implementa la operacion empiezaConJ y la longitud y con el predicado valida
		// el filtro.
